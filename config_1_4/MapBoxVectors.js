...
var queryChanged = function()
{
    ...
    {
        case "MapBox Terrain":
            tileJson = "http://a.tiles.mapbox.com/v3/mapbox.mapbox-terrain-v1.json";
            config = "https://raw.githubusercontent.com/trailbehind/tm2-projects/master/topomap.tm2/project.xml";
            wviz.setTitle("MapBox Terrain");
        break;
        case "MapBox Streets":
            tileJson = "http://a.tiles.mapbox.com/v3/mapbox.mapbox-streets-v4.json";
            config = "http://mousebird.github.io/WhirlyVizConfig/config_1_4/osm-bright.xml";
            wviz.setTitle("MapBox Streets");
            break;
    }
